...
@section('content')
    <div class="col-11 col-xl-9 bg-success-subtle mx-auto border border-success" style="border-radius: 10px">
        <h1 class="bg-success text-light fs-5 text-center mb-0 py-3"
            ...
            <span style="margin-left: 5px">EDIT PEGAWAI</span>
        </h1>
        ...
        <form action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="POST" class="p-3 px-sm-5" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="text" class="form-control p-2 border-success" id="nama" name="nama"
                    value="{{ $pegawai->nama }}" placeholder="Masukkan Nama" required
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="text"
                    ...
                    name="nik" value="{{ $pegawai->nik }}" minlength="16" maxlength="16" placeholder="Masukkan NIK"
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="date" class="form-control p-2 border-success" id="tanggal_lahir" name="tanggal_lahir"
                    value="{{ $pegawai->tanggal_lahir }}" placeholder="Masukkan Tanggal Lahir" required
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="text" class="form-control p-2 border-success" id="alamat" name="alamat"
                    value="{{ $pegawai->alamat }}" placeholder="Masukkan Alamat" required
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="email"
                    ...
                    id="email" name="email" value="{{ $pegawai->email }}" placeholder="Masukkan Email" required
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="text"
                    class="form-control p-2 border-success @error('email') is-invalid border-danger @enderror"
                    id="nomor_telepon" name="nomor_telepon" value="{{ $pegawai->nomor_telepon }}" minlength="12"
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="number" class="form-control p-2 border-success" id="gaji" name="gaji"
                    value="{{ $pegawai->gaji }}" min="0" max="100" step="0.01"
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="text" class="form-control p-2 border-success" id="pendidikan_terakhir"
                    name="pendidikan_terakhir" value="{{ $pegawai->pendidikan_terakhir }}"
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="text" class="form-control p-2 border-success" id="status_perkawinan"
                    name="status_perkawinan" value="{{ $pegawai->status_perkawinan }}"
            ...
            <div class="mx-0 mx-md-5 mx-lg-0 mx-xl-5 mb-4">
                ...
                <input type="number" class="form-control p-2 border-success" id="jumlah_anak" name="jumlah_anak"
                    value="{{ $pegawai->jumlah_anak }}" min="0" max="20" placeholder="Masukkan Jumlah Anak"
